<script lang="ts">
	...
	const DASHBOARD_QUICK_RANGE_ORDER: DashboardQuickRange[] = [
		'Custom',
		'Last30',
		'Last90',
		'Last180',
...
<div class="container-fluid p-0">
	...
	<div class="d-flex align-items-start justify-content-between flex-wrap gap-3 mb-2">
		...
		<form onsubmit={handleApplyFilters} class="d-flex align-items-end gap-2 flex-wrap">
			...
			<div>
				<label class="form-label mb-1" for="dashboard-quick-range"
					>{getMessage('quick_range')}</label
				>
				...
				<div class="card-header d-flex align-items-center justify-content-between">
					<div class="d-flex align-items-center gap-2">
						...
						<span class="fw-semibold">
							{getMessage(
								isAdmin ? 'dashboard_tickets_by_category' : 'dashboard_tickets_by_priority'
							)}
						</span>
					</div>
				</div>
					...
					{#if isAdmin}
						...
						{:else}
							{#key chartKey}
								<div style="height: 200px;">
									<ChartCanvas
										ariaLabel={getMessage('dashboard_chart_bar')}
										config={byCategoryChart}
									/>
								</div>
							{/key}
						{/if}
					{:else if !hasPriorityData}
						<div
							class="d-flex flex-column align-items-center justify-content-center"
							style="height: 200px;"
						>
	...
	<div class="card mt-2">
		<div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
			...
			<div class="text-muted small">
				{getMessage(data.filters.days === 1 ? 'dashboard_last_day' : 'dashboard_last_days', {
