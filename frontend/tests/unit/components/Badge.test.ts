...
describe('Badge', () => {
	...
	it('renders with custom variant (no default bg class)', () => {
		const { container } = render(Badge, { props: { variant: 'custom', class: 'bg-custom-color', label: 'Custom' } });
		const badge = container.querySelector('.badge');
	...
	it('accepts custom class names', () => {
		const { container } = render(Badge, { props: { class: 'my-custom-class', label: 'Custom Class' } });
		const badge = container.querySelector('.badge');
	...
	it('renders with aria-label for accessibility', () => {
		const { container } = render(Badge, { props: { ariaLabel: 'Status: Active', label: 'Active' } });
		const badge = container.querySelector('.badge');
